...
<!---
[![CircleCI Build Status](https://circleci.com/gh/<organization>/<project-name>.svg?style=shield "CircleCI Build Status")](https://circleci.com/gh/<organization>/<project-name>) [![CircleCI Orb Version](https://badges.circleci.com/orbs/devassure/devassure.svg)](https://circleci.com/developer/orbs/orb/devassure/devassure) [![GitHub License](https://img.shields.io/badge/license-MIT-lightgrey.svg)](https://raw.githubusercontent.com/<organization>/<project-name>/master/LICENSE) [![CircleCI Community](https://img.shields.io/badge/community-CircleCI%20Discuss-343434.svg)](https://discuss.circleci.com/c/ecosystem/orbs)
...
[CircleCI Orb Registry Page](https://circleci.com/developer/orbs/orb/devassure/devassure) - The official registry page of this orb for all versions, executors, commands, and jobs described.
...
2. Find the current version of the orb.
    - You can run `circleci orb info devassure/devassure | grep "Latest"` to see the current version.
